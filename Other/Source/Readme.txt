...
user in an INI file next to AegisubPortable.exe called AegisubPortable.ini.
...
copy AppNamePortable.ini from this directory to AegisubPortable.ini next to
AegisubPortable.exe. The options in the INI file are as follows:
